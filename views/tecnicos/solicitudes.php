        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user fa-fw"></i> Lars 88</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Panel de Solicitudes</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <!-- boton -->
                                <p class="mb-0">
                                    <button type="" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalSolicitudes"><i class="fa-solid fa-plus"></i> Reportar Novedad</button>
                        ...
                        <div class="modal-content" id="caja">
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <input type="text" id="categorias" class="form-control input-sm" required>
                                    <br>
                                    <select class="form-select" id="novedad" aria-label="Default select example" required>
                                    ...
                                    <br>
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Ingrese una Descripcion Detallada:</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Adjuntar Info</label>
