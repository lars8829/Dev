        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user fa-fw"></i>Jose Luis Lopez</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tabla').load('../../componentes/tabla.solicitudes.php');
    });
</script>
