...
<table class="table table-hover table-condensed table-bordered" id="CargaDatosNovedadesTecnicos">
                                    <caption>
 ...
 */
                                           ...
                                           $sql = "select n.id, n.titulo, p.nombre, c.nombre, u.email, e.nombre, n.fecha_up
                                           from novedades n 
